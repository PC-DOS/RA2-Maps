-- Modified by Dr. Picsell Dois to fix TNO's ultra-fast map zooming when camera is at max height
-- Tested on TNO v1.5.0c, for other versions, you can modify lines with "P.D." comment
