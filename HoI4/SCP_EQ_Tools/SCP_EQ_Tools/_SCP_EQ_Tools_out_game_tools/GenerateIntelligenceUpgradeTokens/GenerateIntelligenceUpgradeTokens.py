...
# You also need to adjust SCP_EQ_Tools_enhancing_decisions_finish_agency_upgrade_onekey decision in SCP_EQ_Tools_enhancing_decisions.txt
# 
...
if __name__ == "__main__" :
    ...
    #sIdeasOutputFileName = "000_SCP_EQ_Tools_intelligence_agency_upgrades_dummy_ideas.txt"
    #CreateDirectory(sIdeasOutputDir)
    sIdeasInitOutputDir = "../../common/scripted_effects/"
    sIdeasInitOutputFileName = "SCP_EQ_Tools_intelligence_agency_upgrades_scripted_effects.txt"
    ...
    with open(sIdeasInitOutputDir + sIdeasInitOutputFileName, "w", encoding="utf-8") as filOutputFile :
        # Base game
        arrCurrentUpgrades = EnumerateIntelligenceAgencyUpgrades(sHoI4BaseDir)
        filOutputFile.write("SCP_EQ_Tools_intelligence_agency_upgrades_complete_all_upgrades = {" + sLineBreak)
        ...
        for CurrentMod in arrModDirs :
            ...
            filOutputFile.write("SCP_EQ_Tools_intelligence_agency_upgrades_complete_all_upgrades_" + TranslateModName(CurrentMod) + " = {" + sLineBreak)
            filOutputFile.write("    if = {" + sLineBreak)
            filOutputFile.write("        limit = {" + sLineBreak)
            filOutputFile.write("            has_intelligence_agency = no" + sLineBreak)
            filOutputFile.write("        }" + sLineBreak)
