...
if __name__ == "__main__" :
    ...
    sIdeasTokenDefinitionOutputFileName = "SCP_EQ_Tools_national_focuses_dummy_ideas.txt"
    CreateDirectory(sIdeasTokenDefinitionOutputDir)
    sIdeasTokenNationalFocusMappingOutputDir = "../../localisation/simp_chinese/"
    sIdeasTokenNationalFocusMappingOutputFileName = "SCP_EQ_Tools_national_focuses_dummy_ideas_l_simp_chinese.yml"
    CreateDirectory(sIdeasTokenDefinitionOutputDir)
    sIdeasInitOutputDir = "../../common/scripted_effects/"
    sIdeasInitOutputFileName = "SCP_EQ_Tools_national_focuses_dummy_ideas_init_scripted_effects.txt"
    ...
    with open(sIdeasTokenDefinitionOutputDir + sIdeasTokenDefinitionOutputFileName, "w", encoding="utf-8") as filOutputFile :
        ...
        for CurrentFocus in arrFocuses :
            filOutputFile.write("        " + "SCP_EQ_Tools_national_focuses_dummy_ideas_" + CurrentFocus + " = {}" + sLineBreak)
        #Next
    ...
    with open(sIdeasTokenNationalFocusMappingOutputDir + sIdeasTokenNationalFocusMappingOutputFileName, "w", encoding="utf-8-sig") as filOutputFile :
        ...
        for CurrentFocus in arrFocuses :
            filOutputFile.write(" " + "SCP_EQ_Tools_national_focuses_dummy_ideas_" + CurrentFocus + ":0 \" " + CurrentFocus + "\"" + sLineBreak)
        #Next
    #End With
    with open(sIdeasInitOutputDir + sIdeasInitOutputFileName, "w", encoding="utf-8") as filOutputFile :
        filOutputFile.write("SCP_EQ_Tools_national_focuses_dummy_ideas_init_tokens = {" + sLineBreak)
        filOutputFile.write("    clear_array = global.SCP_EQ_Tools_national_focuses_tokens" + sLineBreak)
        for CurrentFocus in arrFocuses :
            filOutputFile.write("    add_to_array = { global.SCP_EQ_Tools_national_focuses_tokens = token:SCP_EQ_Tools_national_focuses_dummy_ideas_" + CurrentFocus + " }" + sLineBreak)
        #Next
        filOutputFile.write(sLineBreak)
        filOutputFile.write("    set_global_flag = SCP_EQ_Tools_is_national_focuses_dummy_ideas_tokens_init_done" + sLineBreak)
        filOutputFile.write("}" + sLineBreak)
    #End With
#End If