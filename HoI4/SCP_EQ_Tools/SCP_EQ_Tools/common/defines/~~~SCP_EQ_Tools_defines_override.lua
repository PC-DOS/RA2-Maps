...
NDefines.NGraphics.GRADIENT_BORDERS_THICKNESS_COUNTRY_LOW = 0.1 --5.0 -- thickness in pixels
...
NDefines.NGraphics.GRADIENT_BORDERS_THICKNESS_COUNTRY_HIGH = 0.1 --25.0