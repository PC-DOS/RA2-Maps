...
NDefines.NGraphics.UNITS_ICONS_DISTANCE_CUTOFF = 545.0
NDefines.NGraphics.CAMERA_OUTSIDE_MAP_DISTANCE_TOP = 450.0
NDefines.NGraphics.CAMERA_OUTSIDE_MAP_DISTANCE_BOTTOM = 450.0
