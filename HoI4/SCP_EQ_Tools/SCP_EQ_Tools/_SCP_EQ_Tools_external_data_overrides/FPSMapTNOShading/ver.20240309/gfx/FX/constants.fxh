...
static const float COLORMAP_OVERLAY_STRENGTH 	= 0.65f;
...
//EndOf: P.D. TNO colormap constants
...
static const float GB_STRENGTH_CH1 = 0.90; // Opacity of bottom layer, higher value == more saturated country color
...
//EndOf: P.D. TNO colormap constants, changes color effects most significantly
